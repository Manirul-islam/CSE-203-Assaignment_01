...
{
    int item,loc=0,i=1;
    printf("Enter an ITEM that you want to searched:");
    scanf("%d",&item);
    for(i=1; i<=size; i++)
    {
        if(arr[i]==item)
...
int main()
{
    ...
    printf("Dear user ,you can do some jobs with your array.if you want to see the job menu,enter 1.otherwise 0\n");
    scanf("%d",&decide);
    if(decide==1)
    {
        choose();
